...
class AddFileButton extends StatefulWidget {
  ...
  const AddFileButton({Key? key, required this.name, required this.subjectId, required this.link}) : super(key: key);
...
class _AddFileButtonState extends State<AddFileButton> {
  ...
  Widget build(BuildContext context) {
    final filesProvider = Provider.of<Files>(context, listen: true);
