import 'package:ac_students/student/models/variabel.dart';
...
class User extends ChangeNotifier {
  ...
  Future<bool> hasUserLogged() async {
    ...
    final ParseResponse? parseResponse =  await ParseUser.getCurrentUserFromServer(sessionToken ?? '');
  ...
  void doUserLogin(TextEditingController emailC, TextEditingController passwordC, int year, BuildContext context) async {
