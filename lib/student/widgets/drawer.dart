...
import 'package:ac_students/student/models/category.dart';
import 'package:ac_students/student/widgets/drawer_item.dart';
import 'package:ac_students/data/categories.dart';
...
class _DrawerWidgetState extends State<DrawerWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    List<Category> specificCategories = !(user.isAdmin ?? false)
              ...
              child: Container(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    List<Category> varCategories = specificCategories;
                    Category varCategory = varCategories[index];
