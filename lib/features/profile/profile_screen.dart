                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Center(
                        child: Container(
                            ...
                            child: Text(
                              ...
                              style:
                                  TextStyle(color: secondaryClr, fontSize: 30),
                            )),
                      ),
                      Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Text('${userProvider.userEmail}',
                                style: TextStyle(
                                    fontSize: 18, color: secondaryClr)),
                          ),
                          Icon(
                            userProvider.verfied
                          ...
                          children: [
                            FittedBox(
                              child: Text(
                                ...
                                style: TextStyle(
                                    fontSize: 15, color: secondaryClr),
                      ...
                      ListTile(
                        onTap: () {
                          Navigator.pushNamed(context, '/FailedScreen');
                        },
                        leading: Icon(
